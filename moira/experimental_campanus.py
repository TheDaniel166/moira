...
class ExperimentalCampanusAdmissibilityMap:
    ...
    practical_windows: tuple[ExperimentalCampanusWindow, ...] = ()
    stability_radius: int = 0
    stable_practical_armcs: tuple[float, ...] = ()
    stable_practical_windows: tuple[ExperimentalCampanusWindow, ...] = ()
...
def scan_experimental_campanus_admissibility(
    ...
    *,
    ...
    practical_windows: list[ExperimentalCampanusWindow] = []
    if practical_armcs:
    ...
    stable_practical_windows: list[ExperimentalCampanusWindow] = []
