...
Boundary:
    Owns: light-time iteration, relativistic aberration (annual and diurnal),
          ...
          parallax shift (scalar and vectorised batch), topocentric diurnal
          aberration (observer velocity due to Earth's rotation), and atmospheric
          refraction.
