...
class ExperimentalAlcabitiusAdmissibilityMap:
    ...
    practical_windows: tuple[ExperimentalAlcabitiusWindow, ...] = ()
    stability_radius: int = 0
    stable_practical_armcs: tuple[float, ...] = ()
    stable_practical_windows: tuple[ExperimentalAlcabitiusWindow, ...] = ()
...
def scan_experimental_alcabitius_admissibility(
    ...
    *,
    ...
    practical_windows: list[ExperimentalAlcabitiusWindow] = []
    if practical_armcs:
    ...
    stable_practical_windows: list[ExperimentalAlcabitiusWindow] = []
