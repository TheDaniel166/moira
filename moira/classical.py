...
from .aspects import (
    ...
    CANONICAL_ASPECTS,
    AspectDirection, HellenisticAspectEvaluationStatus,
    HellenisticOvercomingRelation,
    AspectDomain, AspectFamily, AspectPattern as LegacyAspectPattern,
    AspectPatternKind, AspectTier, MotionState,
    AspectClassification, HellenisticDirectionTruth,
    HellenisticOvercomingTruth, HellenisticSuperiorityTruth,
    AspectFamilyProfile, AspectGraph,
    AspectGraphNode, AspectHarmonicProfile,
    AspectStrength, DeclinationAspect, DeclinationAspectAnalysis,
    DeclinationAspectKind, DeclinationAspectMotionWitness,
    DeclinationAspectPolicy, DeclinationEquatorPolicy,
    DeclinationHemispherePolicy, DeclinationMotionState,
    ...
    find_declination_aspects, find_whole_sign_aspects, find_patterns,
    hellenistic_superiority_truth, overcoming,
)

# ── Dignities (full) ─────────────────────────────────────────────────────
from .dignities import (
    TruthEvaluationStatus, HorizonHemisphere, HorizonComputationMethod,
    SectComponentKind,
    ConditionPolarity,
    PlanetarySolarPhaseKind,
    EssentialDignityKind, AccidentalConditionKind,
    SectStateKind, SolarConditionKind, SolarProximityBand,
    ...
    AccidentalDignityPolicy, DignityComputationPolicy, DignityHorizonFrame,
    ...
    EssentialDignityComponentTruth, PlanetarySolarPhaseTruth,
    SolarProximityTruth, BesiegingDependencyCompletenessTruth,
    BesiegingTruth, MercuryPhaseTruth, HorizonTruth, SectComponentTruth,
    ...
    solar_proximity_truth, planetary_solar_phase_truth, besieging_truth,
    mutual_receptions,
)
...
_CLASSICAL_OWN: list[str] = [
    ...
    "AspectDirection", "HellenisticAspectEvaluationStatus",
    "HellenisticOvercomingRelation",
    "AspectDomain", "AspectFamily", "LegacyAspectPattern", "AspectPatternKind", "AspectTier", "MotionState",
    "AspectClassification", "HellenisticDirectionTruth",
    "HellenisticOvercomingTruth", "HellenisticSuperiorityTruth",
    "AspectFamilyProfile", "AspectGraph",
    "AspectGraphNode", "AspectHarmonicProfile",
    ...
    # Dignities
    "TruthEvaluationStatus", "HorizonHemisphere", "HorizonComputationMethod",
    "SectComponentKind", "ConditionPolarity", "PlanetarySolarPhaseKind",
    "EssentialDignityKind", "AccidentalConditionKind",
    "SectStateKind", "SolarConditionKind", "SolarProximityBand",
    "ReceptionKind", "ReceptionBasis", "ReceptionMode",
    "PlanetaryConditionState",
    ...
    "EssentialDignityComponentTruth", "PlanetarySolarPhaseTruth",
    "SolarProximityTruth", "BesiegingDependencyCompletenessTruth",
    "BesiegingTruth", "MercuryPhaseTruth", "HorizonTruth",
    "SectComponentTruth", "EssentialDignityTruth", "AccidentalDignityCondition",
    "SolarConditionTruth", "MutualReceptionTruth",
    "SectTruth", "AccidentalDignityTruth",
    "PlanetaryDignity",
    "calculate_dignities", "calculate_receptions",
    ...
    "mutual_receptions",
    # Lots
    "LotReferenceKind", "LotReversalKind", "LotArcPolicy",
    "LotDependencyRole", "LotEvaluationStatus",
    "LotConditionState", "LotConditionNetworkEdgeMode",
    "LotsReferenceFailureMode", "LotsDerivedReferencePolicy",
    "LotsExternalReferencePolicy", "LotsComputationPolicy",
    "LotReferenceTruth", "ArabicPartComputationTruth",
