...
BUNDLES: tuple[BundleSpec, ...] = (
    BundleSpec(
        ...
        includes=(
            ...
            "SECURITY.md",
            "LICENSE",
            "wiki/05_research/MOON_FRAME_CONVENTIONS_2026-05-09.md",
            "wiki/07_audit/MOIRA_COMPETITIVE_ANALYSIS_2026-05-25.md",
            "wiki/05_research/MOON_LONGITUDE_RESIDUAL_INVESTIGATION_2026-05-09.md",
            "wiki/03_validation/ASTEROID_ORACLE_VALIDATION_2026-05-09.md",
            "wiki/03_validation/ASTEROID_KERNEL_CLEANUP_2026-05-09.md",
            "wiki/03_validation/ASTEROID_SHARD_16_18_REMOVAL_2026-05-09.md",
            "src/native",
        ),
    ),
    BundleSpec(
