# Primary Directions Midpoint Family Matrix

## Purpose

This document turns the midpoint question in primary directions into explicit
Moira policy.
...
1. what midpoint families seem to exist around primary directions
2. whether they are mathematically recoverable enough for admission
3. whether they belong in the engine, the service layer, or research only


## Constitutional Rule

Midpoint substrate does not by itself justify midpoint admission in primary
directions.

Moira already has strong midpoint mathematics elsewhere in the repo.
That does **not** mean a midpoint is automatically a valid primary-direction
target.

For midpoint directions to be admitted, Moira requires:

1. a clear primary-direction doctrine
2. a governing directional law, not just midpoint construction
3. a branch-specific admission surface
...
- AstroApp exposes midpoint tables and midpoint features in the wider software
  environment:
  - [AstroApp Midpoints help](https://astroapp.com/help/1/mptsW.html)
- modern software and modern astrologers clearly treat midpoints as live
  sensitive points in predictive work:
  - [Mastro user guide](https://mastroapp.com/files/documentation_en.pdf)
  - [AstroWiki, Multiple Directions](https://www.astro.com/astrowiki/en/Multiple_Directions)
...
- current standing: `low-to-medium`
...
The missing piece is not arithmetic.
The missing piece is the directional law.

### Not a Service-Layer Escape

Midpoints should not be pushed into the service layer merely because the engine
law is unclear.
