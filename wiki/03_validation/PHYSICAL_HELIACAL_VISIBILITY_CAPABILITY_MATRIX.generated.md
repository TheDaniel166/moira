...
| `external_ephemeris_event_goldens` | `astronomical_and_event_contract_validation` | 11 | `aa346b80fd045c79` | Twelve independently reconstructed event times cover every admitted target and phase, while four additional matrix cells are explicitly typed engine regressions rather than event-time oracles; none are observed first-visibility dates. |
