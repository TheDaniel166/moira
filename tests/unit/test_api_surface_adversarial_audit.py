...
'ashtakavarga',
    ...
    'ashtakavarga_transit_strength',
    'astrodynes',
    'astrodynes_from_geometry',
    'ayanamsa',
    'bhava_bala',
    'bhava_bala_for_chart',
    'current_lord_of_orb',
    'huber_age_point',
    ...
    'huber_house_zones',
    'huber_intensity_at',
    'integrate_progressed_astrodyne_influence',
    'jaimini_karakas',
    ...
    'lord_of_orb',
    'nine_parts',
    'normal_progressed_astrodynes',
    'panchanga',
    'panchanga_profile',
    'practical_progressed_astrodynes',
    'progressed_astrodyne_accessory_relation',
    'progressed_astrodyne_compound_total_influence',
    'progressed_astrodyne_dated_aspect',
    'progressed_astrodyne_major_relation',
    'progressed_astrodyne_reenforcement',
...
def test_planet_reduction_root_and_facade_exports_share_identity(name: str) -> None:
